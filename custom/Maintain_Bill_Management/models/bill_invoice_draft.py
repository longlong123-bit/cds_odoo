...
class BillInvoiceClass(models.Model):
    _name = 'bill.invoice.draft'

    bill_info_id = fields.Many2one('bill.info.draft', string='Bill Info')
    bill_invoice_details_ids = fields.One2many('bill.invoice.details.draft', 'bill_invoice_id', string='Bill Invoice Details')
