...
class BillInfoClass(models.Model):
    ...
    last_billed_amount = fields.Integer(string='Last Billed Amount', currency_field='currency_id')
    deposit_amount = fields.Integer(string='Deposit Amount', currency_field='currency_id')
    balance_amount = fields.Integer(string='Balance Amount', currency_field='currency_id')
    amount_untaxed = fields.Integer(string='Amount Untaxed', currency_field='currency_id')
    tax_amount = fields.Integer(string='Tax Amount', currency_field='currency_id')
    amount_total = fields.Integer(string="Amount Total", currency_field='currency_id')
    amount_untaxed_cashed = fields.Integer(string='Amount Untaxed Cashed', currency_field='currency_id')
    tax_amount_cashed = fields.Integer(string='Tax Amount Cashed', currency_field='currency_id')
    amount_total_cashed = fields.Integer(string="Amount Total Cashed", currency_field='currency_id')
    billed_amount = fields.Integer(string='Billed Amount', currency_field='currency_id')
    payment_discount_in_invoicing = fields.Integer(currency_field='currency_id')
