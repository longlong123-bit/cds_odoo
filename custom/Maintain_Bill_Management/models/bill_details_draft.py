...
class BillingDetailsClass(models.TransientModel):
    ...
    def prepare_data_for_bill_details_line(self):
        ...
        lines = self.env['bill.details.line.draft'].create(vals)
    ...
    bill_details_line_ids = fields.One2many('bill.details.line.draft', 'bill_details_id', string='Bill Details Line',
...
class BillDetailsLineClass(models.TransientModel):
    _name = 'bill.details.line.draft'
    _order = 'invoice_date asc, invoice_no asc, customer_code asc'

    bill_details_id = fields.Many2one('bill.details.draft', 'Bill Details')
