...
class LeadCustom(models.Model):
    ...
    def _auto_init(self):
        res = super(LeadCustom, self)._auto_init()
    ...
    def create(self, vals):
        ...
        result = super(LeadCustom, self.with_context(context)).create(vals)
    ...
    def write(self, vals):
        ...
        write_result = super(LeadCustom, self).write(vals)
    ...
    def _update_probability(self):
        ...
        for lead in self:
            if lead.id in lead_probabilities:
                ...
                super(LeadCustom, lead).write(proba_vals)
        return
    ...
    def copy(self, default=None):
        ...
        return super(LeadCustom, self.with_context(context)).copy(default=default)
    ...
    def _fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        res = super(LeadCustom, self)._fields_view_get(view_id=view_id, view_type=view_type, toolbar=toolbar, submenu=submenu)
        if view_type == 'form':
    ...
    def toggle_active(self):
        res = super(LeadCustom, self).toggle_active()
    ...
    def _notify_get_reply_to(self, default=None, records=None, company=None, doc_names=None):
        ...
        if leftover:
            res.update(super(LeadCustom, leftover)._notify_get_reply_to(default=default, records=None, company=company, doc_names=doc_names))
        return res
    ...
    def _message_get_suggested_recipients(self):
        recipients = super(LeadCustom, self)._message_get_suggested_recipients()
        try:
            for lead in self:
                if lead.partner_id:
    ...
    def _message_post_after_hook(self, message, msg_vals):
        ...
        return super(LeadCustom, self)._message_post_after_hook(message, msg_vals)

    def _message_partner_info_from_emails(self, emails, link_mail=False):
        result = super(LeadCustom, self)._message_partner_info_from_emails(emails, link_mail=link_mail)
