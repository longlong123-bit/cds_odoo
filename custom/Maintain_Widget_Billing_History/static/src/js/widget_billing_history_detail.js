odoo.define('Maintain_Billing_History.Detail', function (require) {
'use strict';
...
var DetailHistory = FieldMany2One.extend({
    template : "template_many2one_history_widget_payment_detail",
    //Binding Events
        events : {
...
// registry widget
field_registry.add('Maintain_Billing_History.Detail', DetailHistory);
