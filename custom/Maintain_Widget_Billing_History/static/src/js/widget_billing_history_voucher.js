odoo.define('Maintain_Billing_History.Order', function (require) {
'use strict';
...
var VoucherHistory = FieldMany2One.extend({
    template : "template_many2one_history_widget_payment",
    //Binding Events
        events : {
            'click .show_payment_history_dialog' : 'open',
        },
...
var ViewDialog = Dialog.extend({
    xmlDependencies: ['/Maintain_Widget_Billing_History/static/src/xml/dialog_custom_voucher.xml'],
        ...
        _.each(buttons, function (buttonData) {
            ...
            if(buttonData.classes!='btn-secondary o_search_button_search'){
                ...
                if(hasButtonSearch.length==0){
                    ...
                    self.render_datepicker('search_payment_date_from');
                    self.render_datepicker('search_payment_date_to');
                }
            }
            $('.cp_paging').html(cp);
...
//        }
//
//        var f_payment_date_from_val = $('.search_payment_date_from').find('input').val()
//        if (f_payment_date_from_val!=''){
//            var f_payment_date_from = ["payment_date", ">=",f_payment_date_from_val];
//            domain.push(f_payment_date_from)
//        }
//
//        var f_payment_date_to_val = $('.search_payment_date_to').find('input').val()
//        if (f_payment_date_to_val!=''){
//            var f_payment_date_to = ["payment_date", "<=",f_payment_date_to_val];
//            domain.push(f_payment_date_to)
//        }
//
...
// registry widget
field_registry.add('Maintain_Billing_History.Order', VoucherHistory);
