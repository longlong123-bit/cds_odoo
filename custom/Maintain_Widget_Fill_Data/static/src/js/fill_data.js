odoo.define('Maintain.fill_data_invoice', function(require){
    "use strict";
    ...
    var ViewDialog = Dialog.extend({
        xmlDependencies: ['/Maintain_Widget_Fill_Data/static/src/xml/dialog.xml'],
...
//                        });
    ...
    Widget.include({
        events: _.extend({}, Widget.prototype.events, {
            'click .o_fill_data': '_onOpenSearchDialog'
        }),
         ...
         * On print report
         */
        _onOpenSearchDialog: function(e){
            // new dialog and show
