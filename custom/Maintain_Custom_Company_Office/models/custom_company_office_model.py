...
class ClassCompanyOffice(models.Model):
    _name = 'company.office.custom'
    ...
    company_office_fax = fields.Char(string='Fax')
    ...
    def init(self):
        ...
        sup = super(ClassCompanyOffice, self)
        if hasattr(sup, 'init'):
            sup.init()
    ...
    def _name_search(self, name, args=None, operator='ilike', limit=100, name_get_uid=None):
        ...
        return super(ClassCompanyOffice, newself.with_context(context))._name_search(name=name, args=args, operator=operator,
    ...
    def create(self, vals):
        ...
        if not vals.get('name') or vals.get('partner_id'):
            self.clear_caches()
            return super(ClassCompanyOffice, self).create(vals)
        ...
        self.clear_caches()
        company = super(ClassCompanyOffice, self).create(vals)
    ...
    def write(self, values):
        ...
        return super(ClassCompanyOffice, self).write(values)
