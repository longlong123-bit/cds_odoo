odoo.define('web.search_filters_registry_free', function (require) {
"use strict";
...
odoo.define('web._search_filters_registry_free', function(require) {
"use strict";

var registry = require('web.search_filters_registry_free');
