...
ListRenderer.include({
    ...
    _selectCell: function (rowIndex, fieldIndex, options) {
        ...
        var self = this;
        return this._selectRow(rowIndex).then(function (isMe) {
            if(typeof isMe === 'undefined' || !isMe){
                var d = $(".invoice_create span[name='invoice_custom_discountunitprice']");
                var q = $(".invoice_create input[name='quantity']");
                var a = $(".invoice_create span[name='invoice_custom_lineamount']");
                if(typeof d.html !== 'undefined' && typeof q.val() !== 'undefined' && typeof a.html() !== 'undefined'){
                    if(!isMe){
                    if(d.html()<0){
                        d.css("color", "red");
                        }
                        ...
                        parseFloat(a.html().replace(/,/g, ''));

                        if( parseFloat(a.html().replace(/,/g, ''))<0){
                            a.css("color", "red");
                        }
                    }
                }
    ...
    _selectRow: function (rowIndex) {
        ...
        if (rowIndex === this.currentRow) {
            return Promise.resolve(rowIndex === this.currentRow);
        }
        ...
        var self = this;
        if (rowIndex != this.currentRow && $('.invoice_create table tr').hasClass('o_selected_row')) {
                this.unselectRow();
                return Promise.resolve();
         }
